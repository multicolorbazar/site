...
import './Ghost.css';  // Archivo CSS para las animaciones

const Ghost1 = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="60" height="93" viewBox="0 0 15.875 24.606">
    <defs>
      <linearGradient id="A" x1="-1.181" y1="-16.316" x2="16.115" y2="26.184" gradientUnits="userSpaceOnUse">
...
const Ghost2 = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="60" height="93" viewBox="0 0 15.875 24.606">
    <defs>
      <linearGradient id="A" x1="17.056" y1="-16.316" x2="-.24" y2="26.184" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#fff" />
        <stop offset="1" stopColor="#fff" stopOpacity="0" />
      </linearGradient>
    </defs>
